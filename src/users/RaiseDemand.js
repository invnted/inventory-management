  ...
  return (
    <div className='bg-purple-300 h-screen'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='grid grid-cols-1  justify-center items-center bg-purple-300 '>
          <div className='grid grid-cols-1 justify-center items-center m-10 md:mx-20 '>
            <div className='flex justify-center items-center h-auto pb-5 gap-6 text-center text-blue-700  font-bold text-5xl'>
              <Link to='/user-home/raise-demand'>
                <div className='border-4 p-2 border-purple-700 rounded-xl'>Raise Demand</div>
              </Link>
            ...
            <button
              type='submit'
              className='flex justify-center items-center cursor-pointer bg-purple-600 text-white mx-auto w-1/2 md:w-1/3 p-3 m-10 rounded-xl'
            >
              Submit
            </button>
