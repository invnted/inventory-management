    ...
    return (
        <div>
            <div className='bg-purple-300 h-screen'>
                ...
                <div className='bg-purple-500 mx-20'>
                    <form className="max-w-md mx-auto md:pt-20 p-6">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm rounded-lg bg-purple-900 placeholder-gray-300 outline-none text-white" placeholder="Search Using Name / ID" required />
                        </div>
                    </form>
                    <div className="p-2 md:p-10">
                        <button className="bg-purple-900 text-white p-2 rounded-md">Refresh</button>

                        <div className="overflow-x-auto mt-4">
                            <table className="min-w-full bg-purple-300 border">
                                <thead>
                                    <tr>
