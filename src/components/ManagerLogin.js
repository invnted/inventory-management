        ...
        <div className="w-4/5 md:w-1/4 border  rounded-lg shadow p-5">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6">
              <div>
                <label htmlFor="userId" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Manager ID</label>
                <input type="text" name="userId" id="userId"  className="w-full bg-transparent border-b border-gray-300  px-4 py-2 focus:outline-none text-white" placeholder=" Manager ID" required />
              </div>
              <div>
