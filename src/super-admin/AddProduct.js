...
//                 <button type="submit" className='m-5 p-2 outline-none rounded-xl  bg-gray-800  font-bold text-white'>Submit</button>
//                 <button type='upload-CSV' className='m-5 p-2 outline-none rounded-xl  bg-gray-800  font-bold text-white'>Upload CSV</button>
//               </div>
//             </form>
//           </div>
//         </div>
          ...
          <div className='md:px-72 md:p-10'>
            <form className='grid grid-cols-1 md:grid-cols-1' onSubmit={handleSubmit}>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3'>
                ...
                <button type="button" onClick={handleCSVUpload} className='m-5 p-2 outline-none rounded-xl  bg-gray-800  font-bold text-white'>Submit CSV File</button>
              </div>
              {csvFileName && (
